...
**先决条件**: plan.md (必须), spec.md (用户故事必须), research.md, data-model.md, contracts/

**测试**: 下面的示例包含测试任务。测试是可选的 - 仅当功能规范中明确要求时才包含。
...
- 下面显示的路径假设是单体项目 - 请根据 plan.md 的结构进行调整

<!-- 
  ============================================================================
  重要提示: 下面的任务仅作为示例任务用于说明。
...
- [ ] T010 [P] [US1] 在 tests/contract/test_[name].py 中进行 [端点] 的契约测试
- [ ] T011 [P] [US1] 在 tests/integration/test_[name].py 中进行 [用户旅程] 的集成测试
...
- [ ] T018 [P] [US2] 在 tests/contract/test_[name].py 中进行 [端点] 的契约测试
- [ ] T019 [P] [US2] 在 tests/integration/test_[name].py 中进行 [用户旅程] 的集成测试
...
- [ ] T024 [P] [US3] 在 tests/contract/test_[name].py 中进行 [端点] 的契约测试
- [ ] T025 [P] [US3] 在 tests/integration/test_[name].py 中进行 [用户旅程] 的集成测试
...
- **设置 (阶段 1)**: 无依赖 - 可以立即开始
- **基础 (阶段 2)**: 依赖设置完成 - **阻塞**所有用户故事
- **用户故事 (阶段 3+)**: 全部依赖基础阶段完成
  - 用户故事可以并行进行 (如果人员配备允许)
  - 或按优先级顺序进行 (P1 → P2 → P3)
- **完善 (最终阶段)**: 依赖所有预期的用户故事完成
...
任务: "在 tests/contract/test_[name].py 中进行 [端点] 的契约测试"
任务: "在 tests/integration/test_[name].py 中进行 [用户旅程] 的集成测试"
